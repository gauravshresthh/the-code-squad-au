        ...
        <div className="max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:flex lg:gap-10 xl:gap-28 ">
            ...
            <div className="md:flex justify-between xl:gap-20 lg:w-2/3">
              <div className="flex gap-10 xl:gap-10 mt-8 xl:w-1/3">
                <div>
                  <div className="text-primary font-semibold whitespace-pre">Quick Links</div>
                  <div className="text-[#909090] mt-1 text-sm md:text-base flex flex-col">
                    <Link href="/">Home</Link>
                ...
                <div>
                  ...
                  <div className="text-[#909090] text-sm md:text-base mt-1">
                    <div>02 8358 7273</div>
                    <div>Sydney, Australia</div>
                  </div>
                </div>
              </div>
              <div className="mt-8 xl:w-3/5">
          ...
          <div className="mt-8 text-center text-sm text-[#909090] border-t border-slate-200 pt-4">
            &copy; {new Date().getFullYear()} TheCodeSquad - Sydney, Australia. All rights reserved. 
          </div>
        </div>
      </div>
    </div>
